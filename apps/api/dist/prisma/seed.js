...
async function main() {
    ...
    const dists = ['VSHORT', 'SHORT', 'MEDIUM', 'LONG'];
    const classes = ['ECO', 'PREM', 'BUS', 'FIRST'];
    const base = { VSHORT: 0.18, SHORT: 0.14, MEDIUM: 0.11, LONG: 0.09 };
    const classAdj = { ECO: 0, PREM: 0.03, BUS: 0.04, FIRST: 0.11 };
    ...
    const materials = ['METAL', 'PLASTIC', 'GLASS', 'PAPER'];
    const methods = ['REC', 'INC', 'LDF'];
    const wastePer = { REC: 0.25, INC: 0.9, LDF: 1.6 };
    for (const r of regions) {
